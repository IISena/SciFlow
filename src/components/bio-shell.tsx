...
const styles = StyleSheet.create({
  ...
  navWrap: { position: "absolute", bottom: 0, left: 0, right: 0, paddingHorizontal: 8, alignItems: "center" }, nav: { width: "100%", maxWidth: 520, height: 64, borderRadius: 32, backgroundColor: "rgba(25,28,32,0.97)", paddingHorizontal: 4, flexDirection: "row", alignItems: "center", justifyContent: "space-around", boxShadow: "0 8px 32px rgba(0,0,0,0.65)" }, navItem: { flex: 1, minWidth: 54, minHeight: 48, alignItems: "center", justifyContent: "center", gap: 2 }, navIcon: { color: colors.textSecondary, fontSize: 19 }, navLabel: { color: colors.textSecondary, fontSize: 8, fontFamily: Fonts.mono }, navActive: { color: colors.primary, fontWeight: "800" },
